...
_For the person running the workshop. Attendees don't need to read this._

## What success looks like

Every attendee leaves with a **published, playable link** to a game that means something to them. Most reach **Rung 2 (one remixed rule)**; some happily stop at a strong **Rung 1 reskin**. Either is a win. The takeaway you're selling isn't "I can build apps" — it's *"I can turn something I care about into something others can play and feel."*
...
- **"It won't import / run."** Usually WiFi or a branch issue. Point them at **[fixing things](prompts/fixing-things.md)** first; step in if it's a true block.
